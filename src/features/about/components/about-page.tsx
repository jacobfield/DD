      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            our passion for the game and our pride in representing Derby.
          </p>
        </div>
          ...
          <Card className="border-2">
            ...
            <CardContent className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                ...
                bring the excitement of flag American football to Derby and
                create a welcoming community for players of all skill levels.
              </p>
              <p className="text-gray-600 mb-4">
                Since our inception, we've grown from a small group of
                enthusiasts into a competitive team that represents Derby with
                pride across various leagues and tournaments. Our commitment to
                developing players, fostering teamwork, and promoting the sport
                has been at the heart of everything we do.
              </p>
              <p className="text-gray-600">
                Today, we continue to welcome new members, compete at the
                highest levels, and serve as ambassadors for flag football in
                our community.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((value) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-ducks-green to-ducks-purple flex items-center justify-center mx-auto mb-4">
        ...
        <div>
          <Card className="bg-gradient-to-br from-ducks-purple/5 to-ducks-green/5">
            <CardHeader>
              <CardTitle className="text-2xl">What is Flag Football?</CardTitle>
            </CardHeader>
